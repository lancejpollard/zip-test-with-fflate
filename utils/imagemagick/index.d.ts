...
export declare class DrawingWand
  extends NativeInstance
  implements IDrawingWand
{
  private constructor()
...
export declare class MagickImageCollection
...
export declare class PixelCollection
  extends NativeInstance
...
export interface IMagickImage extends IDisposable {
  ...
  connectedComponents(
    settings: ConnectedComponentsSettings,
  ): ConnectedComponent[]
  contrast(): void
...
export declare class MagickImage
  extends NativeInstance
  implements IMagickImage
{
  ...
  set onProgress(
    value: ((event: ProgressEvent$1) => number) | undefined,
  )
